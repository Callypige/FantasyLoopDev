/**
 * Fantasy Loop - Text-Based Game Engine (JavaScript/ES6)
 * 
 ...
 */
class Item {
    constructor(name, description, usable = false, use_message = "") {
        this.name = name;
...
class Game {
    constructor() {
        ...
        this.rooms = new Map();
        this.running = false;
        this.game_title = "Fantasy Loop";
        this.game_intro = "Welcome to the adventure!";
        this.rl = null;
    }
...
module.exports = { Game, Player, Room, Item, createDemoGame };
